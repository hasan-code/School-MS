...
const modal = document.getElementById("AppointTeacher");
const overlay = document.getElementById("overlay");
const btn = document.getElementById("appointTeacherBtn");
...
function showTab(n) {
  ...
  if (n == tab.length - 1) {
    document.getElementById("nextBtn").innerHTML = "Appoint";
  } else {
...
function nextPrev(n) {
  ...
  if (currentTab >= tab.length) {
    document.getElementById("appointTeacherForm").submit();
    return false;
  }
